...
/******/ 	deferredModules.push(["./js/src/hero-slideshow.es6.js","common"]);
...
(function (Drupal) {
  Drupal.behaviors.heroSlideshow = {
    attach: function attach(context) {
      var sliders = context.querySelectorAll('.js-hero-slideshow');
      sliders.forEach(function (slider) {
        var sliderObject = (0, _tinySlider.tns)({
          autoplay: true,
        ...
        sliderObject.events.on('transitionEnd', function () {
          var sliderInfo = sliderObject.getInfo();
...
/******/ });
//# sourceMappingURL=hero-slideshow.min.js.map