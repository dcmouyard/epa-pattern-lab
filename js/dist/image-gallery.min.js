...
/******/ 	deferredModules.push(["./js/src/image-gallery.es6.js","common"]);
...
(function (Drupal) {
  Drupal.behaviors.imageGallery = {
    attach: function attach(context) {
      var sliders = context.querySelectorAll('.js-image-gallery');
      sliders.forEach(function (slider) {
        return (0, _tinySlider.tns)({
          container: slider.querySelector('.js-image-gallery__container'),
          controlsContainer: slider.querySelector('.js-image-gallery__controls'),
          gutter: 16,
